...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="frontend/img/logologo/ayovegan-logo-no-bg.png" />
    <link rel="apple-touch-icon" href="frontend/img/logologo/ayovegan-logo-no-bg.png" />
    ...
    <style>
      .aaaa {
        background-image: url("frontend/img/logologo/ayovegan-logo-no-bg.png");
        height: 8rem;
        width: 8rem;
    ...
    <title>AyoVegan &mdash; Mind your meals!</title>
  </head>
  <body>
    <header class="header">
      <a href="index.php">
    ...
    <main>
      <section class="section-hero">
        <div class="hero">
          <div class="hero-text-box">
            ...
            <div class="delivered-meals">
              <div class="delivered-imgs">
                <img src="frontend/img/customers/customer-1.jpg" alt="Customer photo" />
                <img src="frontend/img/customers/customer-2.jpg" alt="Customer photo" />
                <img src="frontend/img/customers/customer-3.jpg" alt="Customer photo" />
                <img src="frontend/img/customers/customer-4.jpg" alt="Customer photo" />
                <img src="frontend/img/customers/customer-5.jpg" alt="Customer photo" />
                <img src="frontend/img/customers/customer-6.jpg" alt="Customer photo" />
              </div>
          ...
          <div class="hero-img-box">
            <picture>
              <source srcset="frontend/img/hero.webp" type="image/webp" />
              <source srcset="frontend/img/hero-min.png" type="image/png" />

              <img
                src="frontend/img/hero-min.png"
                class="hero-img"
      ...
      <section class="section-meals" id="meals" style="margin-top: -10rem;">
        ...
        <div class="container grid grid--3-cols margin-bottom-md">
          <div class="meal">
            <img
              src="frontend/img/meals/meal-1.jpg"
              class="meal-img"
              alt="Japanese Gyozas"
            />
          ...
          <div class="meal">
            <img
              src="frontend/img/meals/meal-2.jpg"
              class="meal-img"
              alt="Avocado Salad"/>
            <div class="meal-content">
              <div class="meal-tags">
